...
Если есть файлы с похожими названиями, SSH-ключи уже создавались: ```id_dsa.pub```, ```id_ecdsa.pub```, ```id_ed25519.pub```, ```id_rsa.pub```. Если вы не создавали эти файлы, удалите их все.
